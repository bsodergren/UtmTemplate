...
namespace UTMTemplate\Bundle\Carousel\Validator;
...
class UrlValidator
{
    private const ALLOWED_SCHEMES = ['http', 'https', 'javascript', ''];

    /** Schemes interdits (open redirect, XSS) */
    private const DANGEROUS_SCHEMES_PATTERN = '/^(data|vbscript|file|about|ftp|ws|wss):/i';
