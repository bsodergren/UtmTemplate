...
use UTMTemplate\Bundle\Carousel\CarouselItem;
use UTMTemplate\Bundle\Carousel\Exception;
...
class HtmlRenderer extends AbstractRenderer
{
    ...
    private function renderCardItem(CarouselItem $item, int $index, RenderContext $context): string
    {
        ...
        if ($item->hasImageSourceSet()) {
            ...
            if ($shouldLazyLoad) {
                $html .= '<img src="' . $this->escape($item->image) . '" alt="' . $this->escape($item->title ?: '') . '" loading="lazy">';
            } else {
