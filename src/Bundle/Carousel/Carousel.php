...
use UTMTemplate\Bundle\Carousel\Analytics\AnalyticsInterface;
use UTMTemplate\Bundle\Carousel\Exception\InvalidCarouselTypeException;
use UTMTemplate\Bundle\Carousel\Validator\IdSanitizer;
use UTMTemplate\Bundle\Carousel\Validator\OptionsValidator;
...
class Carousel
{
    ...
    private ?Renderer\CompositeRenderer $renderer = null;
     ...
     */
    private function getRenderer(): Renderer\CompositeRenderer
    {
        if (null === $this->renderer) {
            $this->renderer = new Renderer\CompositeRenderer();
        }
